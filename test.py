...
def generate_pdf():
    # Create a PDF file
    pdf_filename = "business_permit.pdf"
    ...
    c.drawString(200, height - 50, "DIANA WANGUI MUTHONI")
    c.setFont("Helvetica", 12)
    c.drawString(500, height - 50, "2024")

    # Permit Information
    c.setFont("Helvetica-Bold", 10)
    c.drawString(30, height - 80, "COUNTY GOVERNMENT OF KILIFI")
    c.drawString(30, height - 100, "RABAI SUB COUNTY")
    ...
    data = [
        ...
        ["Business Name", "NDEWA AGROVET"],
        ["Certificate of Registration No/ID No", "36691638"],
        ["Pin No.", "N/A"],
        ["VAT No.", "N/A"]
    ]
    ...
    c.drawString(250, height - 350, "110; MEDIUM TRADER, SHOP OR RETAIL SERVICES FROM 5 TO 20 EMPLOYEES")
    c.drawString(30, height - 370, "Detailed Activity Description")
    c.drawString(250, height - 370, "Agrovet Services")
    ...
    c.drawString(150, height - 630, "14-Mar-2024")
    c.drawString(30, height - 650, "Validity Period")
    c.drawString(150, height - 650, "31-Dec-2024")

    # Officer Information
    c.drawString(30, height - 690, "Name of the Officer issuing this Permit")
    c.drawString(250, height - 690, "Kahindi Kimera")
